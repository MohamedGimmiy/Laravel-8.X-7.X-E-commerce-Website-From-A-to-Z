...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('{{asset("front-end/images/bg_1.jpg")}}');">
      <div class="container">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li>
                            <a href="{{{url('/view_product_by_category_name/'.$category->category_name)}}}" class="{{ request()->is('view_product_by_category_name/'.$category->category_name) ? 'active': '' }}">
